...
async function getHttp(url) {
    try {
        ...
        console.log(
            ershow[0].children[1].children[1].children[0].data,
            ershow[0].children[1].children[3].children[0].data,
            ershow[0].children[1].children[5].children[0].data,
            ershow[0].children[1].children[7].children[0].data,
            ershow[0].children[1].children[9].children[0].data
        ); //name
        console.log(
            ershow[0].children[27].children[1].children[0].data,
            ershow[0].children[27].children[3].children[0].data,
            ershow[0].children[27].children[5].children[0].data,
            ershow[0].children[27].children[7].children[0].data,
            ershow[0].children[27].children[9].children[0].data
        ); //name
    } catch(e) {
        console.log(e);
    }
