...
async function getHttp(url) {
    try {
        ...
        for (let i = 1; i<=27; i+=2) {
            console.log(
                ershow[0].children[i].children[1].children[0].data,
                ershow[0].children[i].children[3].children[0].data,
                ershow[0].children[i].children[5].children[0].data,
                ershow[0].children[i].children[7].children[0].data,
                ershow[0].children[i].children[9].children[0].data
            ); //name
        }
    } catch(e) {
        console.log(e);
