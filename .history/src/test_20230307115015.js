...
async function getHttp(url) {
    ...
    console.log(ershow.length, ershow[0].children[1].children[1].children[0]); //name
    console.log(ershow.length, ershow[0].children[1].children[3].children[0]); //总套数
    console.log(ershow.length, ershow[0].children[1].children[5].children[0]); //总面积
    console.log(ershow.length, ershow[0].children[1].children[7].children[0]); //住宅套数
    console.log(ershow.length, ershow[0].children[1].children[9].children[0]); //住宅面积
...
getHttp('http://zwfw.fgj.hangzhou.gov.cn/hzfcweb_ifs/interaction/scxx');
