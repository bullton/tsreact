...
async function getHttp(url) {
    try {
        ...
        console.log(ershow.length, ershow[0].children[27].children[1].children[0].data); //name
        console.log(ershow.length, ershow[0].children[27].children[3].children[0].data); //总套数
        console.log(ershow.length, ershow[0].children[27].children[5].children[0].data); //总面积
        console.log(ershow.length, ershow[0].children[27].children[7].children[0].data); //住宅套数
        console.log(ershow.length, ershow[0].children[27].children[9].children[0].data); //住宅面积
    } catch(e) {
        console.log(e);
    }
