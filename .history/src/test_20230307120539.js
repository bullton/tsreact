...
async function getHttp(url) {
    try {
        ...
        console.log(ershow.length, ershow[0].children[1].children[8].children[0].data); //住宅面积
        console.log(ershow.length, ershow[0].children[1].children[9].children[0].data); //住宅面积
        console.log(ershow.length, ershow[0].children[1].children[10].children[0].data); //住宅面积
