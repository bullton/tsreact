...
export const Listings: React.FC<HouseProps> = ({ city, date, houseType, pagesize, bargainType }) => {
  ...
  const fetchData = () => {
    ...
    let url = `/api/listings?houseType=${houseType}&startDate=${dateRange.startDate}&endDate=${dateRange.endDate}`;
    city && (url += `&city=${city}`);
